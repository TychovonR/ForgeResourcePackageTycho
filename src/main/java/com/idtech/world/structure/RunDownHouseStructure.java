package com.idtech.world.structure;


import com.google.common.collect.ImmutableList;
import com.idtech.BaseMod;
import com.mojang.serialization.Codec;
import com.idtech.world.STStructures;
import com.idtech.world.StructureTutorialMain;
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        JigsawConfiguration newConfig = new JigsawConfiguration(
                ...
                () -> context.registryAccess().ownedRegistryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                        .get(new ResourceLocation(BaseMod.MODID, "run_down_house/start_pool")),
        ...
        if (structurePiecesGenerator.isPresent()) {
            ...
            BaseMod.LOGGER.log(Level.DEBUG, "Rundown House at " + blockpos);
        }
